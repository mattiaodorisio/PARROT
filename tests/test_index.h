...
template<typename Index, typename... Args>
void runForN(const int N = 1000, Args &&... args) {
...
void test_index(Args &&... args) {
    runManualTests<Index>(std::forward<Args>(args)...);
    // Additional tests
    runForN<Index>(0, std::forward<Args>(args)...);
    runForN<Index>(1, std::forward<Args>(args)...);
    runForN<Index>(10, std::forward<Args>(args)...);
    runForN<Index>(1000, std::forward<Args>(args)...);
    runForN<Index>(100000, std::forward<Args>(args)...);
