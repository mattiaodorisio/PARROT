...
namespace DeLI {
    ...
    template<bool dynamic, RhtOptimization rht_opt, bool rht_use_simd, TopLevelOptimization opt, typename T, unsigned int high_bits, unsigned int value_bits =
    sizeof(T) * CHAR_BIT>
    class DeLI {
    ...
    private:
        ...
        std::vector<bucket<prec_pred_succ, RHT<dynamic, low_bits, rht_opt, rht_use_simd>>> top_level;
    ...
    public:
        ...
        */
        ...
        using inner_const_iterator = typename RHT<dynamic, low_bits, rht_opt, rht_use_simd>::const_iterator;
